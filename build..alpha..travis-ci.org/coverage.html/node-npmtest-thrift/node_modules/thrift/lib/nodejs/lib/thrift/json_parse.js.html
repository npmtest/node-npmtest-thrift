...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-thrift/node_modules/thrift/lib/nodejs/lib/thrift/json_parse.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-thrift/node_modules/thrift/lib/nodejs/lib/thrift/json_parse.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">4.55% <small>(6 / 132)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-thrift/node_modules/thrift/lib/nodejs/lib/thrift/</a> &#187; json_parse.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            throw new SyntaxError(m);</span>
        },
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                error("Bad number");</span>
            } else <span class="cstat-no" title="statement not covered" >if (number &gt;= Int64.MAX_INT || number &lt;= Int64.MIN_INT) {</span>
...
// Skip whitespace.
&nbsp;
<span class="cstat-no" title="statement not covered" >            while (ch &amp;&amp; ch &lt;= ' ') {</span>
<span class="cstat-no" title="statement not covered" >                next();</span>
            }
        },
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                if (ch === ']') {</span>
<span class="cstat-no" title="statement not covered" >                    next(']');</span>
<span class="cstat-no" title="statement not covered" >                    return array; </span>  // empty array
                }
...
<span class="cstat-no" title="statement not covered" >                if (ch === '}') {</span>
<span class="cstat-no" title="statement not covered" >                    next('}');</span>
<span class="cstat-no" title="statement not covered" >                    return object; </span>  // empty object
                }
<span class="cstat-no" title="statement not covered" >                while (ch) {</span>
<span class="cstat-no" title="statement not covered" >                    key = string();</span>
<span class="cstat-no" title="statement not covered" >                    white();</span>
<span class="cstat-no" title="statement not covered" >                    next(':');</span>
<span class="cstat-no" title="statement not covered" >                    if (Object.hasOwnProperty.call(object, key)) {</span>
<span class="cstat-no" title="statement not covered" >                        error('Duplicate key "' + key + '"');</span>
                    }
...
<span class="cstat-no" title="statement not covered" >            return number();</span>
        default:
<span class="cstat-no" title="statement not covered" >            return ch &gt;= '0' &amp;&amp; ch &lt;= '9'</span>
                ? number()
                : word();
        }
    };
...
&nbsp;
    return <span class="fstat-no" title="function not covered" >function (source) {</span>
<span class="cstat-no" title="statement not covered" >        var result;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        text = source;</span>
